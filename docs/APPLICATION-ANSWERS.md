...
> 492 glyphs, because that is the point of it.
>
...
> Latin — take the inventory to the 492 above.) No font engineering
...
> - 128 tests, fontbakery-gated CI, 15 font families under the SIL Open
>   Font License, 17 command-line tools, and 14 documents. The studio
...
> Twelve of the fifteen font families were generated by the pipeline from one
