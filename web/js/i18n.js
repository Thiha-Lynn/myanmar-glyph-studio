...
(function () {
  ...
  var STRINGS = {
    ...
    taper:          { en: "Taper",          my: "အထူပြောင်း" },
    brushHint:      { en: "hold Shift: straight stroke · , . resize",
                      my: "Shift ဖိထား — မျဉ်းဖြောင့် · , . အရွယ်ပြောင်း" },
    filterPh:       { en: "Find a letter — က, ka, 1004…",
                      my: "အက္ခရာရှာရန် — က၊ ka၊ 1004…" },
    onlyEmpty:      { en: "Only empty",     my: "အလွတ်သာ" },
    allDrawn:       { en: "All {n} glyphs have ink — congratulations! 🎉",
                      my: "အက္ခရာ {n} လုံးလုံး ဆွဲပြီးပါပြီ — ဂုဏ်ယူပါတယ်! 🎉" },
    guide:          { en: "Guide",          my: "လမ်းညွှန်" },
    size:           { en: "Size",           my: "အရွယ်" },
    penPressure:    { en: "Pressure",       my: "ဖိအား" },
    tilt:           { en: "Tilt",           my: "စောင်း" },
    hideList:       { en: "Hide the glyph list",  my: "အက္ခရာစာရင်း ဖျောက်ရန်" },
    showList:       { en: "Show the glyph list",  my: "အက္ခရာစာရင်း ပြရန်" },
    fitWidth:       { en: "Fit width",      my: "အကျယ်ကိုက်" },
    fitWidthDone:   { en: "Advance set to {n} from the ink",
                      my: "အကျယ်ကို မျဉ်းအလိုက် {n} ထားလိုက်ပါပြီ" },
    noInk:          { en: "no ink yet",     my: "မရေးရသေး" },
    advanceShort:   { en: "adv",            my: "အကျယ်" },
    inkShort:       { en: "ink",            my: "မျဉ်း" },
